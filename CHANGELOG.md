...
- Added support for creating SQL server firewall rules via the command: `azmcp sql server firewall-rule create`. [[#779](https://github.com/Azure/azure-mcp/pull/779)]
