...
| azmcp-storage-blob-download | Download blob <blob> from container <container> in storage account <account> to my local file system |
| azmcp-storage-blob-download | Download the blob <blob> from container <container> in storage account <account> to the file /tmp/downloaded-file.txt |
| azmcp-storage-blob-download | Download blob <blob> from container <container> in storage account <account> and overwrite the existing local file |
