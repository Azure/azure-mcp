...
| azmcp-storage-datalake-file-upload | Upload the file <local_file_path> to the Data Lake file system <file_system_name> in storage account <account_name> at path <destination_path> |
| azmcp-storage-datalake-file-upload | Upload a local file to my Data Lake Storage |
