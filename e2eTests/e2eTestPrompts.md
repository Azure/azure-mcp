...
| azmcp-workbooks-list | Show me the Azure Monitor workbooks in my resource group |
| azmcp-workbooks-list | What workbooks do I have in resource group <resource_group_name>? |
| azmcp-workbooks-show | Show me the details of workbook with display name <workbook_display_name> |
| azmcp-workbooks-show | Get information about the workbook with resource ID <workbook_resource_id> |
| azmcp-workbooks-create | Create a new monitoring workbook named <workbook_name> |
| azmcp-workbooks-update | Update the workbook <workbook_resource_id> with new visualization content |
