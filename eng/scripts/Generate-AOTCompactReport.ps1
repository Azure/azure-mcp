...
# the file containing the raw AOT compact output generated by the `dotnet publish` command.
$reportPath = "$aotReportDir/aot-compact-report.txt"
# A JSON file where each entry is a DLL name and AOT warnings from types in that DLL.
...
function Invoke-HTMLReportGeneration {
    param(
