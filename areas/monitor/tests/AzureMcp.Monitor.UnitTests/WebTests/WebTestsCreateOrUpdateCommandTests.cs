...
public class WebTestsCreateOrUpdateCommandTests
{
    ...
    public void RegisterOptions_AddsAllExpectedOptions()
    {
        ...
        // Optional options
        Assert.Contains("webtest-name", options);
    ...
    {
        // Arrange
        var args = new string[] { "--subscription", "sub1", "--resource-group", "rg1", "--webtest-resourcename", "webtest1", "--appinsights-component", "/subscriptions/sub1/resourceGroups/rg1/providers/Microsoft.Insights/components/appinsights1", "--location", "eastus", "--webtest-locations", "US East", "--request-url", "https://example.com" };
        var expectedResult = new WebTestDetailedInfo
        {
            ResourceName = "webtest1",
            Location = "eastus",
    ...
    public async Task ExecuteAsync_ValidCompleteInput_ReturnsSuccess()
    {
        // Arrange
        var args = new string[] {
            "--subscription", "sub1", "--resource-group", "rg1", "--webtest-resourcename", "webtest1",
            "--appinsights-component", "/subscriptions/sub1/resourceGroups/rg1/providers/Microsoft.Insights/components/appinsights1",
            "--location", "eastus", "--webtest-locations", "US East,US West", "--request-url", "https://example.com",
            "--webtest-name", "My Web Test", "--description", "Test description", "--enabled", "true",
    ...
    [InlineData("--subscription sub1 --resource-group rg1 --webtest-resourcename webtest1")] // Missing app-insights-component-id and others
