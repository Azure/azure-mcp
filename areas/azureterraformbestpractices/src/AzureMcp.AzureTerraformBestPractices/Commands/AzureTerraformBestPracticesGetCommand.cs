...
public sealed class AzureTerraformBestPracticesGetCommand(ILogger<AzureTerraformBestPracticesGetCommand> logger) : BaseCommand()
{
    ...
    public override string Description =>
        ...
        generating or suggesting any Terraform code specific to Azure. This command returns the content 
        of the markdown file as a string array. If this tool needs to be categorized, it belongs to 
