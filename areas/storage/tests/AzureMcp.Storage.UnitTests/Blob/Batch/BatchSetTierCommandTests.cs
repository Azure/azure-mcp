...
public class BatchSetTierCommandTests
{
    ...
    {
        // Arrange
        var expectedResult = new BatchSetTierResult(
            _knownBlobNames.ToList(),
            new List<string>()
        );
        ...
        var result = JsonSerializer.Deserialize<Models.BatchSetTierResult>(json);
