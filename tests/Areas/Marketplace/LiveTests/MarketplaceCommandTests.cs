    ...
    IClassFixture<LiveTestFixture>
{
    ...
    [Fact]
    [Trait("Category", "Live")]
    public async Task Should_get_marketplace_product_microsoft_windowsserver()
    {
        // Arrange - microsoftwindowsserver.windowsserver is a well-known Azure Marketplace product
        const string productId = "microsoftwindowsserver.windowsserver";
        ...
        // Verify properties specific to microsoftwindowsserver.windowsserver
    ...
    {
        // Arrange
        const string productId = "Microsoft.Azur";
