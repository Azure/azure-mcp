...
namespace AzureMcp.Tests.Commands.Foundry;
...
public class ModelDeploymentCommandTests
{
    ...
    public async Task ExecuteAsync_DeploysModel_WhenValidOptionsProvided()
    {
        ...
        var expectedDeploymentResource = Substitute.For<CognitiveServicesAccountDeploymentResource>();
        ...
        _foundryService.DeployModel(
            ...
            .Returns(expectedDeploymentResource);
    ...
    public async Task ExecuteAsync_OptionalParameters_PassedToService()
    {
        ...
        var expectedDeploymentResource = Substitute.For<CognitiveServicesAccountDeploymentResource>();
        expectedDeploymentResource.Data.Returns(new CognitiveServicesAccountDeploymentData());
