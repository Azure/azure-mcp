...
3. **Command Pattern**
   ...
   Each command is:
   - Registered in the RegisterCommands method of its service's Areas/{Service}/{Service}Setup.cs file
...
1. Options class: `src/Areas/{Service}/Options/{Resource}/{Operation}Options.cs`
2. Command class: `src/Areas/{Service}/Commands/{Resource}/{Resource}{Operation}Command.cs`
3. Service interface: `src/Areas/{Service}/I{Service}Service.cs`
4. Service implementation: `src/Areas/{Service}/{Service}Service.cs`
5. Unit test: `tests/Areas/{Service}/UnitTests/{Resource}/{Resource}{Operation}CommandTests.cs`
6. Integration test: `tests/Areas/{Service}/LiveTests/{Service}CommandTests.cs`
7. Command registration in RegisterCommands(): `src/Areas/{Service}/{Service}Setup.cs`
