...
namespace AzureMcp.Commands.Monitor.Health.Entity;

public sealed class EntityGetHealthCommand : BaseMonitorHealthCommand<EntityGetHealthArguments>
{
    protected override string GetCommandName() => "get-health";
