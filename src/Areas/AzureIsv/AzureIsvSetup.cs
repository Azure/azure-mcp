...
using AzureMcp.Areas.AzureIsv.Datadog.Commands;
...
internal class AzureIsvSetup : IAreaSetup
{
    ...
    {
        RegisterDatadogCommands(rootGroup, loggerFactory);
    }

    private void RegisterDatadogCommands(CommandGroup rootGroup, ILoggerFactory loggerFactory)
    {
