...
internal class AppConfigSetup : IAreaSetup
{
    ...
    public void RegisterCommands(CommandGroup rootGroup, ILoggerFactory loggerFactory)
    {
        ...
        accounts.AddCommand("list", new AccountListCommand(loggerFactory.CreateLogger<AccountListCommand>()));
        keyValue.AddCommand("list", new KeyValueListCommand(loggerFactory.CreateLogger<KeyValueListCommand>()));
        keyValue.AddCommand("lock", new KeyValueLockCommand(loggerFactory.CreateLogger<KeyValueLockCommand>()));
        keyValue.AddCommand("unlock", new KeyValueUnlockCommand(loggerFactory.CreateLogger<KeyValueUnlockCommand>()));
