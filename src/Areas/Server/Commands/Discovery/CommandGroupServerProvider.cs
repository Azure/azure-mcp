...
public sealed class CommandGroupServerProvider(CommandGroup commandGroup) : IMcpServerProvider
{
    ...
    /// <remarks>
    /// The arguments generated by this method are validated by integration tests
    /// in CommandGroupServerProviderTests to ensure they can be properly parsed
    /// by the ServiceStartCommand. If you modify this method, ensure the
    /// corresponding tests still pass to maintain argument compatibility.
    /// </remarks>
