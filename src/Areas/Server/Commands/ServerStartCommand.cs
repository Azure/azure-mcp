...
public sealed class ServerStartCommand : BaseCommand
{
    ...
    private readonly Option<string> _transportOption = ServerOptionDefinitions.Transport;
    private readonly Option<int> _portOption = ServerOptionDefinitions.Port;
    private readonly Option<string?> _serviceTypeOption = ServerOptionDefinitions.ServiceType;
