...
internal class CosmosSetup : IAreaSetup
{
    ...
    public void RegisterCommands(CommandGroup rootGroup, ILoggerFactory loggerFactory)
    {
        ...
        cosmosContainer.AddCommand("list", new ContainerListCommand(loggerFactory.CreateLogger<ContainerListCommand>()));
        cosmosAccount.AddCommand("list", new AccountListCommand(loggerFactory.CreateLogger<AccountListCommand>()));
        cosmosItem.AddCommand("query", new ItemQueryCommand(loggerFactory.CreateLogger<ItemQueryCommand>()));
    }
}
