...
namespace AzureMcp.Core.UnitTests.Services.Azure.Authentication;
...
public class AuthenticationIntegrationTests : IAsyncLifetime
{
    ...
    {
        Assert.SkipWhen(Tests.Extensions.IsRunningFromDotnetTest(), Tests.Extensions.RunningFromDotnetTestReason);
