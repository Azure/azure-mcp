...
public class McpRuntimeTests
{
    ...
    public void Constructor_WithValidParameters_InitializesCorrectly()
    {
        ...
        var mockResourceLoader = Substitute.For<IResourceLoader>();
        var mockTelemetry = CreateMockTelemetryService();
        var options = CreateOptions();

        // Act
        var runtime = new McpRuntime(mockToolLoader, mockResourceLoader, options, mockTelemetry, logger);
    ...
    public void Constructor_WithNullToolLoader_ThrowsArgumentNullException()
    {
        ...
        var exception = Assert.Throws<ArgumentNullException>(() =>
            new McpRuntime(null!, mockResourceLoader, options, mockTelemetry, logger));
    ...
    public void Constructor_WithNullOptions_ThrowsArgumentNullException()
    {
        ...
        // Act & Assert
        var exception = Assert.Throws<ArgumentNullException>(() =>
            new McpRuntime(mockToolLoader, mockResourceLoader, null!, mockTelemetry, logger));
    ...
    public void Constructor_WithNullTelemetry_ThrowsArgumentNullException()
    {
        ...
        var exception = Assert.Throws<ArgumentNullException>(() =>
            new McpRuntime(mockToolLoader, mockResourceLoader, options, null!, logger));
    ...
    public void Constructor_WithNullLogger_ThrowsArgumentNullException()
    {
        ...
        var exception = Assert.Throws<ArgumentNullException>(() =>
            new McpRuntime(mockToolLoader, mockResourceLoader, options, mockTelemetry, null!));
    ...
    public async Task ListToolsHandler_WithCancellationToken_PassesTokenToToolLoader()
    {
        ...
        var mockResourceLoader = Substitute.For<IResourceLoader>();
        var options = CreateOptions();
        var runtime = new McpRuntime(mockToolLoader, mockResourceLoader, options, CreateMockTelemetryService(), logger);
    ...
    public void Constructor_WithDifferentServiceOptions_LogsCorrectly()
    {
        ...
        var runtime1 = new McpRuntime(mockToolLoader, mockResourceLoader, options1, CreateMockTelemetryService(), logger);
        ...
        var runtime2 = new McpRuntime(mockToolLoader, mockResourceLoader, options2, CreateMockTelemetryService(), logger);
        ...
        var runtime3 = new McpRuntime(mockToolLoader, mockResourceLoader, options3, CreateMockTelemetryService(), logger);
    ...
    public async Task Runtime_ImplementsIMcpRuntimeInterface()
    {
        ...
        var mockResourceLoader = Substitute.For<IResourceLoader>();
        var options = CreateOptions();
        IMcpRuntime runtime = new McpRuntime(mockToolLoader, mockResourceLoader, options, CreateMockTelemetryService(), logger);
    ...
    public async Task DisposeAsync_ShouldDisposeToolLoader()
    {
        ...
        var runtime = new McpRuntime(mockToolLoader, mockResourceLoader, options, mockTelemetryService, logger);
