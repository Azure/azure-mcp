...
/// </summary>
[HiddenCommand]
public class ServiceStartCommand : BaseCommand
{
    ...
    /// <summary>
    /// Configures logging for the MCP server. Override in derived classes to add specific logging providers.
    /// </summary>
    /// <param name="logging">The logging builder to configure.</param>
    protected virtual void ConfigureLogging(ILoggingBuilder logging)
    {
        // Default implementation does nothing - derived classes can override to add specific providers
    }

    /// <summary>
    /// Configures additional services for the MCP server. Override in derived classes to add specific services.
    /// </summary>
