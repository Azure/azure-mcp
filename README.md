...
- "List my Azure Monitor workbooks"
* "Show me the workbook with display name 'Performance Dashboard'"
* "Create a new monitoring workbook"
* "Update my workbook with new visualizations"
